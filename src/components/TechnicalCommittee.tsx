  ...
  const sections = [
    {
      ...
      members: [
        ...
        { name: "Mr. Govind Kumar", image: "/govind_kumar.jpeg" }
      ]
    },
    {
    ...
    },
    {
      ...
      members: [
        { name: "Dr. Surmadhur Pant", image: "/PANT-SIR.webp" },
        { name: "Dr. U. C. Gupta", image: "/ucgupta.png" },
        { name: "Dr. Santosh Joshi", image: "/Santosh-JoshI.jpg" },
        { name: "Prof. (Dr.) Sayantan Mukhopadhyay", image: "/Dr.-Sayantan.png" },
